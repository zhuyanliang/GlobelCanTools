...
/**
  ...
  *                  false: 失败
  */
bool ExcelEngine::SaveDataFrTableView(QTableView *tableView,QStandardItemModel *model)
{
...
/**
  *@brief 从指定的xls文件中把数据导入到tableView中
  *@param tableView : 执行要导入到的tableview指针
  *@return 导入成功与否 true : 成功
  *                   false: 失败
  */
bool ExcelEngine::ReadDataToTableView(QTableView *tableView)
{
    return true;
}
